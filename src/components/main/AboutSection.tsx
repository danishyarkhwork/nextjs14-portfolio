...
const AboutSection: FC = () => {
  return (
    <section data-scroll-index="0" id="about">
      <div className="about-section px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
        ...
        <div className="mt-7 md:mt-10">
          ...
          <p className="max-w-2xl mt-4 md:mt-6">
            ...
            and I began using WordPress when I first started. I have spent most
            of my waking hours for the last ten years designing, programming,
            and operating{" "}
            <span className="text-black dark:text-white">WordPress</span> sites
            that go beyond with exclusive design.
          </p>
        </div>
        <div className="mt-6">
          <div className="inline-flex flex-wrap items-center gap-2 mb-5 text-sm">
          ...
          <ul className="grid grid-cols-2 gap-6 md:grid-cols-4 xl:gap-8">
            <li>
              <div className="mb-1 text-2xl font-semibold md:text-3xl text-theme 2xl:text-4xl">
                <span>185</span>+
              </div>
