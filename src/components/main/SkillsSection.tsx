          ...
          <div className="swiper">
            <div className="swiper-wrapper *:space-y-5 *:text-center">
              ...
              <div className="swiper-slide">
                ...
                <div className="text-black dark:text-white name">Tailwind</div>
              </div>
              <div className="swiper-slide">
                <div className="text-center icon">
                  <img
                ...
                <div className="text-black dark:text-white name">HTML5</div>
              </div>
              <div className="swiper-slide">
                <div className="text-center icon">
                  <img
                ...
                <div className="text-black dark:text-white name">CSS3</div>
              </div>
              <div className="swiper-slide">
                <div className="text-center icon">
                  <img
